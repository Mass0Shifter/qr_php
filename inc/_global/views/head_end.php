...
?>
    ...
    <link rel="stylesheet" id="css-main" href="<?php echo $zero->assets_folder; ?>/css/oneui.min.css">

    <!-- You can include a specific file from css/themes/ folder to alter the default color theme of the template. eg: -->
    <!-- <link rel="stylesheet" id="css-theme" href="assets/css/themes/amethyst.min.css"> -->
    <?php if ($zero->theme) { ?>
    <link rel="stylesheet" id="css-theme" href="<?php echo $zero->assets_folder; ?>/css/themes/<?php echo $zero->theme; ?>.css">
    <?php } ?>
    <!-- END Stylesheets -->
</head>
<body>
