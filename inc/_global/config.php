...
require(PROJECT_PATH.'/inc/_classes/Template.php');
...
$zero                             = new Template('Luzcasa', '1.0', '../assets');
...
$zero->title                      = 'Luzcasa Buildings - User Page';
$zero->description                = 'Luzcasa Buildings';
